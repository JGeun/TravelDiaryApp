...
import com.hansung.traveldiary.src.bulletin.BulletinDaySectionAdapter
...
class OtherUserDiaryDaySectionAdapter(private val index: Int, private val size: Int,private val userImagePath:String): RecyclerView.Adapter<OtherUserDiaryDaySectionAdapter.ViewHolder>() {
